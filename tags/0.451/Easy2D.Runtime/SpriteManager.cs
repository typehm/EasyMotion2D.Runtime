...
namespace EasyMotion2D
{
    ...
    internal class SpritePrimitiveGroup
    {
        ...
        internal SetIndexer<SpritePrimitiveGroup> priHolder;
        ...
        {
            if (priHolder.isValid)
            {
                SpriteManager.RemovePrimitiveGroupFromLayer(layer, priHolder);
                priHolder.Init();
            }
        }
    ...
    internal class SpriteLayer
    {
        ...
        internal int id;
        internal Set<SpritePrimitiveGroup> baseContainer = new Set<SpritePrimitiveGroup>();
