...
namespace EasyMotion2D
{
    ...
    public class SpriteRenderer : MonoBehaviour, SpriteRenderable
    {
        ...
        //[HideInInspector]
        [SerializeField]
        protected SpriteTransform[] spriteTransforms = new SpriteTransform[1] { null };
        ...
        void SetupSpritePrimitiveXY(SpritePrimitive pri, SpriteTransform sTransform, Vector2 parentPosition, float parentRotation, Vector2 parentScale, int layer, ref bool isFirst)
        {
        ...
        void SetupSpritePrimitiveZY(SpritePrimitive pri, SpriteTransform sTransform, Vector2 parentPosition, float parentRotation, Vector2 parentScale, int layer, ref bool isFirst)
        {
            sTransform.primitive = pri;
