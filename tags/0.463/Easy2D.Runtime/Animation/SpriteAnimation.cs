...
namespace EasyMotion2D
{
    ...
    {
        /// <summary>
        /// Where to update animation.
        /// </summary>
        public SpriteRendererUpdateMode updateMode = SpriteRendererUpdateMode.Update;
        ...
        /// <summary>
        /// If true, SpriteAnimatino will call SpriteRenderer.Apply automatcally after evaluate curves.
        /// </summary>
        public bool autoApplyAfterUpdate = true;

        /// <summary>
        /// SpriteAnimation component transform handler delegate.
        /// </summary>
        ...
        public void SetClipRange( string name, float startTime, float endTime)
        {
            ...
            if (state != null)
            {
                ...
                state.normalizedSpeed = 1f / state.length;
            }
            else
            {
        ...
        string DumpDict()
        {
            ...
            {
                SpriteAnimationState state = animationStates[key];
                str += key + ", " + 
                    state.name + ", " + 
                    state.enabled + ", " +
                    state.time + ", " +
