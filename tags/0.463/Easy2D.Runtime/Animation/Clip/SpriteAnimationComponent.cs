...
namespace EasyMotion2D
{
    ...
    public class SpriteAnimationComponent
    {
        ...
        [HideInInspector]
        public float minRotateAngle = -3600;

        [HideInInspector]
        public float maxRotateAngle = 3600;
        ...
        public SpriteAnimationComponent parent
        {
            ...
            set
            {
                ...
                _fullPathHash = EasyMotion2DUtility.GetHashCode(_fullPath);
            }
        }
